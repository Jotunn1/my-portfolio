...
export default function Hero() {
  const { ref } = useSectionScroll("Hero", 0.5);
  ...
  return (
    <section
      ref={ref}
      id="hero"
      className="pb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]"
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="/my-photo.jpg"
              alt="Ihor Bozhuk profile picture"
              width="400"
              height="400"
              quality="95"
              priority={true}
      ...
      >
        <span className="font-bold">Hello, I'm Ihor.</span>
        <br /> I'm a front-end developer with 2 years of experience. I enjoy
        building sites & apps. My focus is React and Next.js.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/ihor-bozhuk-aba4451a8/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
